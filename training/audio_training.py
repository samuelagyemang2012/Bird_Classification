...
# Define paths
IMG_BASE_PATH = "C:/Users/Administrator/Desktop/Sam/Multimodal_Fusion/training_data/new_spectograms/"
TRAIN_DATA_PATH = "../data/training/audio/train.csv"
TEST_DATA_PATH = "../data/training/audio/test.csv"
...
for tr in train_:
    file = tr.split(".")[0]
    img = cv2.imread(IMG_BASE_PATH + file + ".png")
